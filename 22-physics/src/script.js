...
import CANNON from "cannon"; //npm i --save cannon

// CREATING PHYSICS tension, friction, bouncing, constraints, pivots, etc
// Theory is to create a phisics word to govern the three.js environment
// 3D Physics Libraries  Ammo.js, Cannon.js, Oimo.js
// 2D Physics libraries Matter.js, P2.js, Planck.js, Box2D.js
// console.log(CANNON);
...
//   {
//     friction: 0.1,
//     restitution: 0.7, // resilience default is 0.3
//   }
// );
// world.addContactMaterial(concretePlasticContactMaterial);

// Matertials  1 default material
...
// world.defaultContactMaterial = defaultContactMaterial  //this line applies the contact material to everything
...
// Geometry and Material for every sphere
...
// Geometry and Material for every BOX
...
const createBox = (width, height, depth, position) => {
  ...
  ); //needs to be half for cannon boxes
  const body = new CANNON.Body({
    mass: 1,
    position: new CANNON.Vec3(0, 3, 0),
    shape,
...
const tick = () => {
  ...
  // Applying outside force like wind
  // sphereBody.applyForce(new CANNON.Vec3(-0.5, 0, 0), sphereBody.position);

  world.step(1 / 60, deltaTime, 3); //.step(timeStep, deltaTime)
